			...
			for (String category: getCategories()) {
				for (String areaCat: getHierachy().getNameSpaces()) {
					...
					if (first < 0 ){
						...
						firstAreaCat = areaCat;
					}
					else {
						if (total != first) {
							String message = "Period:"+period+": "+firstCategory+","+firstAreaCat+","+first+" Not consistent with: "+category+","+areaCat+","+total;
